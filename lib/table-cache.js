...
// Warehouse-level whole-table cache. Dropped immediately on writes/scrapes via invalidateTableCache().
...
export const SELECTS = {
    ...
    batches: 'year, label, academic_year, default_scheme, is_active, sort_order, created_at'
};
...
/** Returns the timestamp of the most recent table cache invalidation. */
export function getLastTableInvalidation() {
