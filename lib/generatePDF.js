...
export async function generateResultPDF({
    ...
    const totalSummaryHeight = 20 + 6 + semTableRowsHeight + 16 + 14 + 24;
    ...
    // ===== PLATFORM ENGINEERING ATTRIBUTION BLOCK =====
    if (y + 24 > maxUsableY) {
        doc.addPage();
        y = 16;
    }
    ...
    const pillW = Math.round(totalTextW + 16);
    const pillH = 6.8;
    ...
    doc.roundedRect(pillX, y, pillW, pillH, 3.4, 3.4, 'FD');
    ...
    // Segment 2: Mohammed Ainan Armar
    doc.setFontSize(7.5);
