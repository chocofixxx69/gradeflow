...
function getLegacyPasswordPepper() {
    const pepper = process.env.LEGACY_STUDENT_PASSWORD_PEPPER;
    if (!pepper) {
        throw new Error('LEGACY_STUDENT_PASSWORD_PEPPER is not configured. Pre-migration student passwords cannot be verified.');
    }
    return pepper;
}
