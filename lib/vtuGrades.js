...
export function getGradePoint(grade, scheme = '2022', totalMarks = null, externalMarks = null) {
    ...
    if (['F', 'A', 'X', 'NE', 'ABSENT', 'AB', 'FAIL'].includes(unified) || g === 'F' || g === 'A' || g === 'AB') return 0;
    ...
    // 2. If letter grade is explicit (O, S, A+, A, B+, B, C, P), map directly
    const letterMap = { 'O': 10, 'S': 10, 'A+': 9, 'A': 8, 'B+': 7, 'B': 6, 'C': 5, 'P': 4 };
