 ...
 *
 * VTU RULE:
 *   - Regular students: USN number portion is 001–199  (e.g. 2AB23CS043)
 *   - Lateral entry students: USN number portion is 200+  (e.g. 2AB24CS400)
 *   - Lateral entry students are admitted the NEXT calendar year with the
 *     NEXT year's USN prefix, but belong to the PREVIOUS year's academic cohort.
...
export function isLateralEntryUSN(usn) {
    ...
    // VTU lateral entry students have number >= 200 (in practice 400-series)
    return num >= 200;
}
