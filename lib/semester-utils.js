 ...
 * @param {Object} options - { isLateralEntry: boolean, usn: string, branch: string }
 * @returns {Object} - { grouped, stats, cgpa, totalCredits, totalEarnedCredits, semesterCount, ncEligibility, yearBackRisk }
 */
export function processStudentResults(marks, scheme = '2022', options = {}) {
    ...
    const record = calculateAcademicRecord(filteredMarks, {
        usn: options.usn || '',
